...
class Mongoose {
  ...
  constructor(modelName, config, name) {
     ...
     * 添加自增长id
     */
    if (this.autoIncrementOptions && this.autoIncrementOptions.model && this.autoIncrementOptions.field) {
      autoIncrement.initialize(connection);
      schema.plugin(autoIncrement.plugin, this.autoIncrementOptions);
    }
